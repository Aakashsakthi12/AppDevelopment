package com.example.aakash.team7.Service;
...
import com.example.aakash.team7.Repository.BookmystayRepository;
@Service
public class BookmystayService {
	...
	public Bookmystay getbookmystay(Long bookmystayId) {
